...
namespace eosio {
	...
	class [[eosio::contract("eosio.lynx")]] eosiolynx : public contract {
		public:
			using contract::contract;

			[[eosio::action]]
			void setperm(name acc, const std::map<std::string,uint8_t>& perms);
			using setperm_action = eosio::action_wrapper<"setperm"_n, &eosiolynx::setperm>;

			[[eosio::action]]
			void setperm2(name acc, const std::vector<uint8_t>& perms);
			using setperm2_action = eosio::action_wrapper<"setperm2"_n, &eosiolynx::setperm2>;

			[[eosio::action]]
			void remove(name acc);
			using remove_action = eosio::action_wrapper<"remove"_n, &eosiolynx::remove>;

			[[eosio::action]]
			void reqperm(name acc, std::string permission );
			using reqperm_action = eosio::action_wrapper<"reqperm"_n, &eosiolynx::reqperm>;
			
			[[eosio::action]]
			void setuserava(name acc, std::string ava );
			using setuserava_action = eosio::action_wrapper<"setuserava"_n, &eosiolynx::setuserava>;

			[[eosio::action]]
			void setuserdata(name acc, std::string data );
			using setuserdata_action = eosio::action_wrapper<"setuserdata"_n, &eosiolynx::setuserdata>;
			
			[[eosio::action]]
			void setusername(name acc, std::string name );
			using setusername_action = eosio::action_wrapper<"setusername"_n, &eosiolynx::setusername>;
			
			[[eosio::action]]
			void userverify(name acc, bool  verified);
			using userverify_action = eosio::action_wrapper<"userverify"_n, &eosiolynx::userverify>;

			[[eosio::action]]
			void userprimary(name acc, bool  primary);
			using userprimary_action = eosio::action_wrapper<"userprimary"_n, &eosiolynx::userprimary>;

			[[eosio::action]]
			void migration(name acc, std::string name, std::string avatar, bool verified, uint64_t date, std::string data, bool primary);
			using migration_action = eosio::action_wrapper<"migration"_n, &eosiolynx::migration>;

			[[eosio::action]]
			void dappreg(name account);
			using dappreg_action = eosio::action_wrapper<"dappreg"_n, &eosiolynx::dappreg>;

			[[eosio::action]]
			void setdappconf(uint64_t ram, uint64_t cpu, uint64_t net);
			using setdappconf_action = eosio::action_wrapper<"setdappconf"_n, &eosiolynx::setdappconf>;
