...
#include <eosio.lynx/eosio.lynx.hpp>  //LYNX
...
namespace eosiosystem {
   ...
   static constexpr int64_t  inflation_precision           = 100;     // 2 decimals 100 LYNX
   static constexpr int64_t  default_annual_rate           = 0;     // 5% annual rate LYNX 
   static constexpr int64_t  pay_factor_precision          = 10000;
   static constexpr int64_t  default_inflation_pay_factor  = 0;   // LYNX producers pay share = 10000 / 50000 = 20% of the inflation
   static constexpr int64_t  default_votepay_factor        = 0;   // LYNX  per-block pay share = 10000 / 40000 = 25% of the producer pay
   ...
   struct [[eosio::table("global"), eosio::contract("eosio.system")]] eosio_global_state : eosio::blockchain_parameters {
      ...
      uint64_t             max_ram_size = 16ll*1024 * 1024 * 1024; //LYNX 64ll ->16ll   (16GB)
   ...
   class [[eosio::contract("eosio.system")]] system_contract : public native {
      ...
      public:
		 ...
		 static constexpr eosio::name lynx_account{"eosio.lynx"_n};      // LYNX
		...
		static uint8_t checkPermission(name acc, std::string permission); //LYNX
