...
namespace eosiosystem {
   ...
   void system_contract::buyram( const name& payer, const name& receiver, const asset& quant )
   {
      ...
      check (checkPermission(payer, "buyram")==1, "You are not authorised to buyram.");  // LYNX Check Permissions
  ...
  /**
   ...
   void system_contract::sellram( const name& account, int64_t bytes ) {
      ...
      check (system_contract::checkPermission(account, "sellram")==1, "You are not authorised to sellram.");  // LYNX Check Permissions
                                     ...
                                     const asset& stake_cpu_quantity, bool transfer )
   {
      ...
      check (system_contract::checkPermission(from, "delegate")==1, "You are not authorised to delegate.");  // LYNX Check Permissions
                                       ...
                                       const asset& unstake_net_quantity, const asset& unstake_cpu_quantity )
   {
      ...
      check (system_contract::checkPermission(from, "undelegate")==1, "You are not authorised to undelegate.");  // LYNX Check Permissions
