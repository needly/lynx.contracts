...
namespace eosiosystem {
   ...
   void system_contract::regproducer( const name& producer, const eosio::public_key& producer_key, const std::string& url, uint16_t location ) {
      ...
      check (checkPermission(producer, "regprod")==1, "You are not authorised to register as producer");  // LYNX Check Permissions
   ...
   void system_contract::voteproducer( const name& voter_name, const name& proxy, const std::vector<name>& producers ) {
      ...
      check (checkPermission(voter_name, "vote")==1, "You are not authorised to Vote");  // LYNX Check Permissions
   ...
   void system_contract::regproxy( const name& proxy, bool isproxy ) {
      ...
      check (checkPermission(proxy, "regproxy")==1, "You are not authorised to register as proxy");  // LYNX Check Permissions
